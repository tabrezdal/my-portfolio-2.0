const TestimonialData = [
  {
    ...
    review:
      "We hired Tabrez for a complete UI/UX redesign of our platform, and he exceeded expectations. His exceptional design knowledge and technical expertise created a visually striking yet highly functional interface. Designs and prototypes were not only stunning but also user-friendly, ensuring an intuitive experience across the entire application. He built a comprehensive design system that streamlined our workflow. his ability to blend design with technical requirements, while aligning with our business goals, was invaluable. We’re extremely pleased and highly recommend him for any UI/UX project.",
    sourceUrl:
  ...
  },
  {
    ...
    location: "Bangalore, India",
    review:
      "Tabrez is our go-to choice for a landing page project, and he once again proved his expertise in UI/UX. His creativity and meticulous attention to detail shone through, resulting in a design that was not only on-brand but also user-focused, effectively driving engagement and conversions. Despite a tight deadline, Tabrez delivered a high-quality result with remarkable attention to detail. His communication and professionalism throughout the project were excellent. We will definitely be hiring him for future projects!",
    sourceUrl:
      "https://www.upwork.com/freelancers/tabrezdal",
  },
  {
